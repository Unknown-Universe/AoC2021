...
console.log(epsilonRate(splitInput));

console.log(`Output: ${gammaRate(splitInput) * epsilonRate(splitInput)}`);

function oxygenGenRating(input) {
...
// console.log(oxygenGenRating(splitInput));
// console.log(co2Rating(splitInput));

console.log(oxygenGenRating(splitInput) * co2Rating(splitInput));
